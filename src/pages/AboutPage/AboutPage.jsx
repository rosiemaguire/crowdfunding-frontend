...
function AboutPage() {
  return (
    <article id="about">
      ...
      <h3>Why &quot;Advocat&quot;?</h3>
      <p>
        Advocat is a play on the words &quot;advocate&quot; and &quot;cat&quot;. Advocat is all
        about being advocates for our and others pets. We believe that pets are
      ...
      <p>
        ...
        <a href="https://github.com/rosiemaguire/crowdfunding-frontend#contributing">
          README
        </a>
        .
      </p>
